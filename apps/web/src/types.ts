...
export type ChapterMeta={id:string;title:string;position:number;durationMs:number;isSample:boolean;locked?:boolean;sentenceCount?:number;rating?:number;sections?:ChapterSection[]};
