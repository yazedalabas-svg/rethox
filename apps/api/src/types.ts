...
export type ChapterSection = { id:string; title:string; sentenceId:string; position:number; isSample?:boolean };
export type Chapter = { id:string; bookId:string; title:string; position:number; durationMs:number; isSample:boolean; sentences:Sentence[]; illustrations?:ChapterIllustration[]; sentenceCount?:number; contentFile?:string; sections?:ChapterSection[]; volumeNumber?:number; volumePosition?:number; sampleTruncated?:boolean };
