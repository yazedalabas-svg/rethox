...
export type Chapter = { id:string; bookId:string; title:string; position:number; durationMs:number; isSample:boolean; sentences:Sentence[]; illustrations?:ChapterIllustration[]; sentenceCount?:number; contentFile?:string; sections?:ChapterSection[] };
